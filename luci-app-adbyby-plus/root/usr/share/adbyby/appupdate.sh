...
# path is file/*
# check and via https://github.com/ywt114/no-adbyby/tree/master/files
...
Hi, friend.
You can also via https://github.com/ywt114/no-adbyby/tree/master/files by youself, if you need.
